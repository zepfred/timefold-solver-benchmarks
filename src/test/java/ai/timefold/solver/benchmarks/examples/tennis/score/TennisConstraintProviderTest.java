package ai.timefold.solver.benchmarks.examples.tennis.score;
...
import ai.timefold.solver.benchmarks.examples.tennis.domain.Day;
import ai.timefold.solver.benchmarks.examples.tennis.domain.Team;
...
import ai.timefold.solver.benchmarks.examples.tennis.domain.UnavailabilityPenalty;
import ai.timefold.solver.test.api.score.stream.ConstraintVerifier;

class TennisConstraintProviderTest
        extends
        AbstractConstraintProviderTest<TennisConstraintProvider, TennisSolution> {
    ...
    void oneAssignmentPerDayPerTeam(
            ConstraintVerifier<TennisConstraintProvider, TennisSolution> constraintVerifier) {
        ...
        constraintVerifier.verifyThat(
                TennisConstraintProvider::oneAssignmentPerDatePerTeam)
    ...
    void unavailabilityPenalty(
        ...
        constraintVerifier
                .verifyThat(TennisConstraintProvider::unavailabilityPenalty)
    ...
    void fairAssignmentCountPerTeam(
        ...
        constraintVerifier.verifyThat(
                TennisConstraintProvider::fairAssignmentCountPerTeam)
    ...
    void evenlyConfrontationCount(
        ...
        constraintVerifier
                .verifyThat(
                        TennisConstraintProvider::evenlyConfrontationCount)
                .given(assignment1, assignment2, assignment3)
                .penalizesBy(1732);
        // Team 2 twice while everyone else just once = more unfair.
        constraintVerifier
    ...
    @Override
    protected ConstraintVerifier<TennisConstraintProvider, TennisSolution>
