...
class ConferenceSchedulingConstraintProviderTest
    ...
    void roomUnavailableTimeslot(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::roomUnavailableTimeslot)
                .given(talk1, talk2)
    ...
    void roomConflict(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::roomConflict)
    ...
    void speakerRequiredTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::speakerRequiredTimeslotTags)
                .given(talk1, talk2)
    ...
    void speakerProhibitedTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::speakerProhibitedTimeslotTags)
                .given(talk1, talk2)
    ...
    void talkRequiredTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::talkRequiredTimeslotTags)
                .given(talk1, talk2)
                .penalizesBy(MONDAY_10_TO_11.getDurationInMinutes());
    }
    ...
    void talkProhibitedTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::talkProhibitedTimeslotTags)
                .given(talk1, talk2)
                .penalizesBy(MONDAY_9_TO_10.getDurationInMinutes());
    }
    ...
    void speakerPreferredTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::speakerPreferredTimeslotTags)
                .given(talk1, talk2)
                .penalizesBy(MONDAY_10_TO_11.getDurationInMinutes());
    }
    ...
    void speakerUndesiredTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::speakerUndesiredTimeslotTags)
                .given(talk1, talk2)
                .penalizesBy(MONDAY_9_TO_10.getDurationInMinutes());
    }
    ...
    void talkPreferredTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::talkPreferredTimeslotTags)
                .given(talk1, talk2)
                .penalizesBy(MONDAY_10_TO_11.getDurationInMinutes());
    }
    ...
    void talkUndesiredTimeslotTags(
        ...
        constraintVerifier.verifyThat(
                ConferenceSchedulingConstraintProvider::talkUndesiredTimeslotTags)
                .given(talk1, talk2)
                .penalizesBy(MONDAY_9_TO_10.getDurationInMinutes());
    }
