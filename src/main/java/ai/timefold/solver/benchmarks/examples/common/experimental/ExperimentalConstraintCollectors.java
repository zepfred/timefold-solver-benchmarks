package ai.timefold.solver.benchmarks.examples.common.experimental;
...
import ai.timefold.solver.benchmarks.examples.common.experimental.api.ConsecutiveIntervalInfo;
import ai.timefold.solver.benchmarks.examples.common.experimental.impl.Interval;
import ai.timefold.solver.benchmarks.examples.common.experimental.impl.IntervalTree;
    ...
    public static <A, PointType_ extends Comparable<PointType_>, DifferenceType_ extends Comparable<DifferenceType_>>
        ...
        return new UniConstraintCollector<>() {
            ...
            public BiFunction<IntervalTree<A, PointType_, DifferenceType_>, A, Runnable> accumulator() {
                return (acc, a) -> {
                    Interval<A, PointType_> interval =
                            acc.getInterval(a);
                    acc.add(interval);
        ...
        return new BiConstraintCollector<>() {
            ...
            public TriFunction<IntervalTree<IntervalType_, PointType_, DifferenceType_>, A, B, Runnable> accumulator() {
                return (acc, a, b) -> {
                    ...
                    Interval<IntervalType_, PointType_> interval =
                            acc.getInterval(intervalObj);
                    acc.add(interval);
                    return () -> acc.remove(interval);
                };
            }
