...
public class PatientAdmissionScheduleImporter
    ...
    public static class PatientAdmissionScheduleInputBuilder
            extends TxtInputBuilder<PatientAdmissionSchedule> {

        private static final Comparator<Room> ROOM_COMPARATOR =
                comparing(Room::getDepartment,
                        comparingLong(Department::getId))
                        .thenComparingLong(Room::getId);
        private static final Comparator<Bed> BED_COMPARATOR =
                comparing(Bed::getRoom, ROOM_COMPARATOR)
        ...
        private void readSpecialismList() throws IOException {
            ...
            List<Specialism> specialismList =
                    new ArrayList<>(specialismListSize);
            ...
            for (int i = 0; i < specialismListSize; i++) {
                ...
                Specialism specialism =
                        new Specialism(Long.parseLong(lineTokens[0]),
                                lineTokens[1]);
        ...
        private void readDepartmentListAndDepartmentSpecialismList() throws IOException {
            ...
            for (int i = 0; i < departmentListSize; i++) {
                ...
                Department department =
                        new Department(Long.parseLong(departmentTokens[0]),
                                departmentTokens[1]);
                ...
                for (int j = 0; j < departmentSpecialismTokens.length; j += 2) {
                    ...
                    if (specialismId != 0) {
                        Specialism specialism =
                                idToSpecialismMap.get(specialismId);
                        if (specialism == null) {
                            throw new IllegalArgumentException("Read line (" + line
                                    + ") has a non existing specialismId (" + specialismId + ").");
                        }
                        DepartmentSpecialism departmentSpecialism =
                                new DepartmentSpecialism(departmentSpecialismId, department,
        ...
        private void readEquipmentList() throws IOException {
            ...
            for (int i = 0; i < equipmentListSize; i++) {
                ...
                String[] lineTokens = splitBySpace(line, 2);
                Equipment equipment =
                        new Equipment(Long.parseLong(lineTokens[0]), lineTokens[1]);
        ...
        private void readRoomListAndRoomSpecialismListAndRoomEquipmentList() throws IOException {
            ...
            List<RoomSpecialism> roomSpecialismList =
                    new ArrayList<>(roomListSize * 5);
            List<RoomEquipment> roomEquipmentList =
                    new ArrayList<>(roomListSize * 2);
            ...
            for (int i = 0; i < roomListSize; i++) {
                ...
                List<RoomSpecialism> roomSpecialismListOfRoom =
                        new ArrayList<>(roomSpecialismTokens.length / 2);
                for (int j = 0; j < roomSpecialismTokens.length; j += 2) {
                    ...
                    if (specialismId != 0) {
                        ...
                        RoomSpecialism roomSpecialism =
                                new RoomSpecialism(roomSpecialismId, room, specialism, priority);
                ...
                List<RoomEquipment> roomEquipmentListOfRoom =
                        new ArrayList<>(equipmentListSize);
                ...
                for (int j = 0; j < roomEquipmentTokens.length; j++) {
                    ...
                    if (hasEquipment == 1) {
                        RoomEquipment roomEquipment =
                                new RoomEquipment(roomEquipmentId, room, indexToEquipmentMap.get(j));
        ...
        private void readBedList() throws IOException {
            ...
            Map<Room, Integer> roomToLastIndexInRoomMap =
                    new HashMap<>(roomListSize);
            for (int i = 0; i < bedListSize; i++) {
                ...
                Bed bed =
                        new Bed(Long.parseLong(lineTokens[0]), room, indexInRoom);
        ...
        private void readPatientListAndAdmissionPartListAndRequiredPatientEquipmentListAndPreferredPatientEquipmentList()
            ...
            List<AdmissionPart> admissionPartList =
                    new ArrayList<>(patientListSize);
            List<RequiredPatientEquipment> requiredPatientEquipmentList =
                    new ArrayList<>(patientListSize * equipmentListSize);
            ...
            for (int i = 0; i < patientListSize; i++) {
                ...
                Patient patient =
                        new Patient(Long.parseLong(patientTokens[0]), patientTokens[1],
                ...
                for (int j = 1; j < admissionPartTokens.length; j += 2) {
                    ...
                    Night admissionPartFirstNight =
                            indexToNightMap.get(admissionPartFirstNightIndex);
                    ...
                    AdmissionPart admissionPart =
                            new AdmissionPart(admissionPartId, patient,
                                    admissionPartFirstNight,
                ...
                for (int j = 0; j < preferredPatientEquipmentTokens.length; j++) {
                    ...
                    if (hasEquipment == 1) {
                        ...
                        if (!alreadyRequired) {
                            PreferredPatientEquipment preferredPatientEquipment =
                                    new PreferredPatientEquipment(
