...
public class MrProcessAssignmentDifficultyComparator
        implements Comparator<MrProcessAssignment> {

    private static final Comparator<MrProcessAssignment> COMPARATOR =
            Comparator
                    .comparingInt((
                            MrProcessAssignment assignment) -> assignment
                                    .getProcess().getUsageMultiplicand())
                    .thenComparingLong(
                            MrProcessAssignment::getId);

    @Override
    public int compare(MrProcessAssignment a,
