package ai.timefold.solver.benchmarks.examples.flightcrewscheduling.domain;
...
public class FlightAssignment extends AbstractPersistable implements Comparable<FlightAssignment> {
    ...
    public FlightAssignment(long id, Flight flight,
            int indexInFlight, Skill requiredSkill) {
        super(id);
        this.flight = flight;
