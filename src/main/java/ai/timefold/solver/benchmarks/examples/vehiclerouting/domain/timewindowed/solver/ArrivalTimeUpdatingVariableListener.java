package ai.timefold.solver.benchmarks.examples.vehiclerouting.domain.timewindowed.solver;
...
public class ArrivalTimeUpdatingVariableListener implements
        VariableListener<VehicleRoutingSolution, Customer> {
    ...
    protected void updateArrivalTime(ScoreDirector<VehicleRoutingSolution> scoreDirector,
        ...
        if (previousCustomer == null) {
            ...
            departureTime =
                    ((TimeWindowedCustomer) previousCustomer)
                            .getDepartureTime();
        }
