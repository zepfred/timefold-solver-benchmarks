package ai.timefold.solver.benchmarks.examples.nurserostering.domain.pattern;
...
public class WorkBeforeFreeSequencePattern extends Pattern {
    ...
    public WorkBeforeFreeSequencePattern(long id, String code, DayOfWeek workDayOfWeek,
