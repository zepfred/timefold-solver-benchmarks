...
public class MachineReassignmentSolutionFileIO extends
        AbstractJsonSolutionFileIO<MachineReassignment> {
    ...
    public MachineReassignment read(File inputSolutionFile) {
         ...
         * the machineList.
         */
        deduplicateEntities(machineReassignment, MachineReassignment::getMachineList,
                MrMachine::getId,
                MrMachine::getMachineMoveCostMap,
                MrMachine::setMachineMoveCostMap);
