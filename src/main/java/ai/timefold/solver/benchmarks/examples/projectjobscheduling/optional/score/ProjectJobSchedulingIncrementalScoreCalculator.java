package ai.timefold.solver.benchmarks.examples.projectjobscheduling.optional.score;
...
import ai.timefold.solver.benchmarks.examples.projectjobscheduling.optional.score.common.NonrenewableResourceCapacityTracker;
import ai.timefold.solver.benchmarks.examples.projectjobscheduling.optional.score.common.RenewableResourceCapacityTracker;
import ai.timefold.solver.benchmarks.examples.projectjobscheduling.optional.score.common.ResourceCapacityTracker;
import ai.timefold.solver.core.api.score.buildin.hardmediumsoft.HardMediumSoftScore;
import ai.timefold.solver.core.api.score.calculator.IncrementalScoreCalculator;

public class ProjectJobSchedulingIncrementalScoreCalculator
        implements
        IncrementalScoreCalculator<Schedule, HardMediumSoftScore> {
    ...
    public void resetWorkingSolution(Schedule schedule) {
        ...
        for (Allocation allocation : schedule
                .getAllocationList()) {
            insert(allocation);
        }
    }
    ...
    private void insert(Allocation allocation) {
        ...
        if (executionMode != null && allocation.getJob()
                .getJobType() == JobType.STANDARD) {
            for (ResourceRequirement resourceRequirement : executionMode
        ...
        if (allocation.getJob()
                .getJobType() == JobType.SINK) {
